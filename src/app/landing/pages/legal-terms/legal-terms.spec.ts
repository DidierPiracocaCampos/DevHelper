...
describe('LegalTerms', () => {
  ...
  it('calls TermsService.load on init and renders the markdown content', () => {
  ...
  it('shows the Aceptar button when the user is logged in and needs re-acceptance', () => {
  ...
  it('hides the Aceptar button when the user is logged in but does not need re-acceptance', () => {
    auth.user.set({ uid: 'u1' });
  ...
  it('calls legalAcceptance.accept with the user uid and source manual on click', () => {
    auth.user.set({ uid: 'u1' });
    legal.needsReAcceptance.mockReturnValue(true);
    fixture.detectChanges();
  ...
  it('renders the raw markdown footer link', () => {
